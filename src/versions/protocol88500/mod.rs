...
pub mod byte_aligned {
    ...
    impl EObserve {
        #[tracing::instrument(name="88500::EObserve::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
    ...
    impl GameEGameSpeed {
        #[tracing::instrument(name="88500::GameEGameSpeed::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_int_tag(input)?;
            let (tail, variant_tag) = parse_vlq_int(tail)?;
            match variant_tag {
    ...
    impl GameSThumbnail {
        ...
        #[tracing::instrument(name="88500::byte_aligned::GameSThumbnail::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameSColor {
        ...
        #[tracing::instrument(name="88500::byte_aligned::GameSColor::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameEResultDetails {
        #[tracing::instrument(name="88500::GameEResultDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_int_tag(input)?;
            let (tail, variant_tag) = parse_vlq_int(tail)?;
            match variant_tag {
    ...
    impl GameSToonNameDetails {
        ...
        #[tracing::instrument(name="88500::byte_aligned::GameSToonNameDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameSPlayerDetails {
        ...
        #[tracing::instrument(name="88500::byte_aligned::GameSPlayerDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_name: Option<Vec<u8>> = None;
    ...
    impl GameCPlayerDetailsArray {
        #[tracing::instrument(name="88500::GameCPlayerDetailsArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
    ...
    impl GameSDetails {
        ...
        #[tracing::instrument(name="88500::byte_aligned::GameSDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
