...
pub mod byte_aligned {
    ...
    impl EObserve {
        #[tracing::instrument(name="89720::EObserve::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
    ...
    impl GameEGameSpeed {
        #[tracing::instrument(name="89720::GameEGameSpeed::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_int_tag(input)?;
            let (tail, variant_tag) = parse_vlq_int(tail)?;
            match variant_tag {
    ...
    impl GameSThumbnail {
        ...
        #[tracing::instrument(name="89720::byte_aligned::GameSThumbnail::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameSColor {
        ...
        #[tracing::instrument(name="89720::byte_aligned::GameSColor::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameEResultDetails {
        #[tracing::instrument(name="89720::GameEResultDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_int_tag(input)?;
            let (tail, variant_tag) = parse_vlq_int(tail)?;
            match variant_tag {
    ...
    impl GameSToonNameDetails {
        ...
        #[tracing::instrument(name="89720::byte_aligned::GameSToonNameDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameSPlayerDetails {
        ...
        #[tracing::instrument(name="89720::byte_aligned::GameSPlayerDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_name: Option<Vec<u8>> = None;
    ...
    impl GameCPlayerDetailsArray {
        #[tracing::instrument(name="89720::GameCPlayerDetailsArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
    ...
    impl GameSDetails {
        ...
        #[tracing::instrument(name="89720::byte_aligned::GameSDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
        ...
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            ...
            Ok((
                ...
                Self {
                    ...
                    m_data_build_num: m_data_build_num
                        .expect("Missing m_data_build_num from struct"),
    ...
    impl ReplayTrackerSUnitBornEvent {
        ...
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            ...
            Ok((
                tail,
                Self {
                    m_unit_tag_index: m_unit_tag_index
                        .expect("Missing m_unit_tag_index from struct"),
                    m_unit_tag_recycle: m_unit_tag_recycle
                        .expect("Missing m_unit_tag_recycle from struct"),
                    m_unit_type_name: m_unit_type_name
                        .expect("Missing m_unit_type_name from struct"),
...
pub mod bit_packed {
    ...
    impl TTeamPreference {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_team: m_team.expect("Missing m_team from struct"),
                },
            ))
        }
    }
    ...
    impl SUserInitialData {
        ...
        pub fn parse_m_race_preference(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), TRacePreference> {
        ...
        pub fn parse_m_team_preference(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), TTeamPreference> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                ...
                Self {
                    ...
                    m_highest_league: m_highest_league
                        .expect("Missing m_highest_league from struct"),
                    m_combined_race_levels: m_combined_race_levels
                        .expect("Missing m_combined_race_levels from struct"),
                    m_random_seed: m_random_seed.expect("Missing m_random_seed from struct"),
                    m_race_preference: m_race_preference
                        .expect("Missing m_race_preference from struct"),
                    m_team_preference: m_team_preference
                        .expect("Missing m_team_preference from struct"),
                    ...
                    m_custom_interface: m_custom_interface
                        .expect("Missing m_custom_interface from struct"),
    ...
    impl GameSCmdAbil {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_abil_link: m_abil_link.expect("Missing m_abil_link from struct"),
                    m_abil_cmd_index: m_abil_cmd_index
                        .expect("Missing m_abil_cmd_index from struct"),
    ...
    impl GameSCmdDataTargetUnit {
        ...
        pub fn parse_m_snapshot_unit_link(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTUnitLink> {
        ...
        pub fn parse_m_snapshot_point(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSMapCoord3D> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_target_unit_flags: m_target_unit_flags
                        .expect("Missing m_target_unit_flags from struct"),
                    m_timer: m_timer.expect("Missing m_timer from struct"),
                    m_tag: m_tag.expect("Missing m_tag from struct"),
                    m_snapshot_unit_link: m_snapshot_unit_link
                        .expect("Missing m_snapshot_unit_link from struct"),
                    m_snapshot_control_player_id: m_snapshot_control_player_id
                        .expect("Missing m_snapshot_control_player_id from struct"),
                    m_snapshot_upkeep_player_id: m_snapshot_upkeep_player_id
                        .expect("Missing m_snapshot_upkeep_player_id from struct"),
                    m_snapshot_point: m_snapshot_point
                        .expect("Missing m_snapshot_point from struct"),
                },
            ))
        }
    }
    ...
    impl GameSSetLobbySlotEvent {
        ...
        pub fn parse_m_slot_change(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSLobbySlotChange> {
    ...
    impl GameSDropUserEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_drop_session_user_id: m_drop_session_user_id
                        .expect("Missing m_drop_session_user_id from struct"),
    ...
    impl GameSUserOptionsEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_game_fully_downloaded: m_game_fully_downloaded
                        .expect("Missing m_game_fully_downloaded from struct"),
                    m_development_cheats_enabled: m_development_cheats_enabled
                        .expect("Missing m_development_cheats_enabled from struct"),
                    m_test_cheats_enabled: m_test_cheats_enabled
                        .expect("Missing m_test_cheats_enabled from struct"),
                    m_multiplayer_cheats_enabled: m_multiplayer_cheats_enabled
                        .expect("Missing m_multiplayer_cheats_enabled from struct"),
                    m_sync_checksumming_enabled: m_sync_checksumming_enabled
                        .expect("Missing m_sync_checksumming_enabled from struct"),
                    m_is_map_to_map_transition: m_is_map_to_map_transition
                        .expect("Missing m_is_map_to_map_transition from struct"),
                    m_debug_pause_enabled: m_debug_pause_enabled
                        .expect("Missing m_debug_pause_enabled from struct"),
                    m_use_galaxy_asserts: m_use_galaxy_asserts
                        .expect("Missing m_use_galaxy_asserts from struct"),
                    ...
                    m_base_build_num: m_base_build_num
                        .expect("Missing m_base_build_num from struct"),
                    ...
                    m_hotkey_profile: m_hotkey_profile
                        .expect("Missing m_hotkey_profile from struct"),
                },
            ))
        }
    }
    ...
    impl GameSPickMapTagEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_picked_map_tag: m_picked_map_tag
                        .expect("Missing m_picked_map_tag from struct"),
                },
            ))
        }
    }
    ...
    impl GameSCameraSaveEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_which: m_which.expect("Missing m_which from struct"),
    ...
    impl GameSPauseGameEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_pause_type_index: m_pause_type_index
                        .expect("Missing m_pause_type_index from struct"),
                },
            ))
        }
    }
    ...
    impl GameSSetGameSpeedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_speed: m_speed.expect("Missing m_speed from struct"),
                },
            ))
        }
    }
    ...
    impl GameSReplayJumpEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_replay_jump_game_loop: m_replay_jump_game_loop
                        .expect("Missing m_replay_jump_game_loop from struct"),
                },
            ))
        }
    }
    ...
    impl GameSSaveGameEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_file_name: m_file_name.expect("Missing m_file_name from struct"),
    ...
    impl GameSCheatEventData {
        ...
        pub fn parse_m_arguments(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCCheatString> {
    ...
    impl GameSSelectionDeltaEvent {
        ...
        pub fn parse_m_control_group_id(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTControlGroupId> {
        ...
        pub fn parse_m_delta(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSSelectionDelta> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_control_group_id: m_control_group_id
                        .expect("Missing m_control_group_id from struct"),
                    m_delta: m_delta.expect("Missing m_delta from struct"),
                },
            ))
        }
    ...
    impl GameSControlGroupUpdateEvent {
        ...
        pub fn parse_m_control_group_index(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTControlGroupIndex> {
        ...
        pub fn parse_m_control_group_update(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameEControlGroupUpdate> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_control_group_index: m_control_group_index
                        .expect("Missing m_control_group_index from struct"),
                    m_control_group_update: m_control_group_update
                        .expect("Missing m_control_group_update from struct"),
    ...
    impl GameSSelectionSyncCheckEvent {
        ...
        pub fn parse_m_selection_sync_data(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSSelectionSyncData> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                ...
                Self {
                    m_control_group_id: m_control_group_id
                        .expect("Missing m_control_group_id from struct"),
                    m_selection_sync_data: m_selection_sync_data
                        .expect("Missing m_selection_sync_data from struct"),
                },
            ))
        }
    }
    ...
    impl GameSResourceTradeEvent {
        ...
        pub fn parse_m_recipient_id(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTPlayerId> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_recipient_id: m_recipient_id.expect("Missing m_recipient_id from struct"),
    ...
    impl GameSTriggerChatMessageEvent {
        ...
        pub fn parse_m_chat_message(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCTriggerChatMessageString> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_chat_message: m_chat_message.expect("Missing m_chat_message from struct"),
                },
            ))
        }
    }
    ...
    impl GameSaiCommunicateEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_beacon: m_beacon.expect("Missing m_beacon from struct"),
                    m_ally: m_ally.expect("Missing m_ally from struct"),
                    m_flags: m_flags.expect("Missing m_flags from struct"),
                    m_build: m_build.expect("Missing m_build from struct"),
                    m_target_unit_tag: m_target_unit_tag
                        .expect("Missing m_target_unit_tag from struct"),
                    m_target_unit_snapshot_unit_link: m_target_unit_snapshot_unit_link
                        .expect("Missing m_target_unit_snapshot_unit_link from struct"),
                    m_target_unit_snapshot_upkeep_player_id:
                        m_target_unit_snapshot_upkeep_player_id
                            .expect("Missing m_target_unit_snapshot_upkeep_player_id from struct"),
                    m_target_unit_snapshot_control_player_id:
                        m_target_unit_snapshot_control_player_id
                            .expect("Missing m_target_unit_snapshot_control_player_id from struct"),
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                ...
                Self {
                    ...
                    m_unit_control_player_id: m_unit_control_player_id
                        .expect("Missing m_unit_control_player_id from struct"),
                    m_unit_upkeep_player_id: m_unit_upkeep_player_id
                        .expect("Missing m_unit_upkeep_player_id from struct"),
                    m_unit_position: m_unit_position.expect("Missing m_unit_position from struct"),
                    m_unit_is_under_construction: m_unit_is_under_construction
                        .expect("Missing m_unit_is_under_construction from struct"),
                    m_pinged_minimap: m_pinged_minimap
                        .expect("Missing m_pinged_minimap from struct"),
    ...
    impl GameSAllianceEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_alliance: m_alliance.expect("Missing m_alliance from struct"),
                    m_control: m_control.expect("Missing m_control from struct"),
                },
            ))
        }
    ...
    impl GameSUnitClickEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_unit_tag: m_unit_tag.expect("Missing m_unit_tag from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerReplySelectedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_conversation_id: m_conversation_id
                        .expect("Missing m_conversation_id from struct"),
    ...
    impl GameSHijackReplaySessionUserInfo {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_session_user_id: m_session_user_id
                        .expect("Missing m_session_user_id from struct"),
                    m_add_new_game_user: m_add_new_game_user
                        .expect("Missing m_add_new_game_user from struct"),
    ...
    impl GameSHijackReplaySessionEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_user_infos: m_user_infos.expect("Missing m_user_infos from struct"),
    ...
    impl GameSTriggerPurchaseMadeEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_purchase_item_id: m_purchase_item_id
                        .expect("Missing m_purchase_item_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerPlanetMissionLaunchedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_difficulty_level: m_difficulty_level
                        .expect("Missing m_difficulty_level from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerDialogControlEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_control_id: m_control_id.expect("Missing m_control_id from struct"),
    ...
    impl GameSTriggerSoundLengthQueryEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_sound_hash: m_sound_hash.expect("Missing m_sound_hash from struct"),
    ...
    impl GameSTriggerSoundLengthSyncEvent {
        ...
        pub fn parse_m_sync_info(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSSyncSoundLength> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_sync_info: m_sync_info.expect("Missing m_sync_info from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerAnimLengthQueryByNameEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_query_id: m_query_id.expect("Missing m_query_id from struct"),
                    m_length_ms: m_length_ms.expect("Missing m_length_ms from struct"),
                    m_finish_game_loop: m_finish_game_loop
                        .expect("Missing m_finish_game_loop from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerAnimOffsetEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_anim_wait_query_id: m_anim_wait_query_id
                        .expect("Missing m_anim_wait_query_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerSoundOffsetEvent {
        ...
        pub fn parse_m_sound(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTTriggerSoundTag> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_sound: m_sound.expect("Missing m_sound from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerTransmissionOffsetEvent {
        ...
        pub fn parse_m_thread(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTTriggerThreadTag> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_transmission_id: m_transmission_id
                        .expect("Missing m_transmission_id from struct"),
    ...
    impl GameSTriggerConversationSkippedEvent {
        ...
        pub fn parse_m_skip_type(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameEConversationSkip> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_skip_type: m_skip_type.expect("Missing m_skip_type from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerMouseClickedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_button: m_button.expect("Missing m_button from struct"),
    ...
    impl GameSAchievementAwardedEvent {
        ...
        pub fn parse_m_achievement_link(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTAchievementLink> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_achievement_link: m_achievement_link
                        .expect("Missing m_achievement_link from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerHotkeyPressedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_hotkey: m_hotkey.expect("Missing m_hotkey from struct"),
                    m_down: m_down.expect("Missing m_down from struct"),
                },
            ))
        }
    ...
    impl GameSTriggerSoundtrackDoneEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_soundtrack: m_soundtrack.expect("Missing m_soundtrack from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerPlanetMissionSelectedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_planet_id: m_planet_id.expect("Missing m_planet_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerKeyPressedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_key: m_key.expect("Missing m_key from struct"),
                    m_flags: m_flags.expect("Missing m_flags from struct"),
                },
            ))
        }
    ...
    impl GameSResourceRequestFulfillEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_fulfill_request_id: m_fulfill_request_id
                        .expect("Missing m_fulfill_request_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSResourceRequestCancelEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_cancel_request_id: m_cancel_request_id
                        .expect("Missing m_cancel_request_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerCommandErrorEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_error: m_error.expect("Missing m_error from struct"),
                    m_abil: m_abil.expect("Missing m_abil from struct"),
                },
            ))
        }
    ...
    impl GameSTriggerResearchPanelSelectionChangedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_research_item_id: m_research_item_id
                        .expect("Missing m_research_item_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerMercenaryPanelSelectionChangedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_mercenary_id: m_mercenary_id.expect("Missing m_mercenary_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerBattleReportPanelPlayMissionEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_battle_report_id: m_battle_report_id
                        .expect("Missing m_battle_report_id from struct"),
                    m_difficulty_level: m_difficulty_level
                        .expect("Missing m_difficulty_level from struct"),
                },
            ))
    ...
    impl GameSDecrementGameTimeRemainingEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_decrement_seconds: m_decrement_seconds
                        .expect("Missing m_decrement_seconds from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerPortraitLoadedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_portrait_id: m_portrait_id.expect("Missing m_portrait_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerMovieFunctionEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_function_name: m_function_name.expect("Missing m_function_name from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerGameMenuItemSelectedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_game_menu_item_index: m_game_menu_item_index
                        .expect("Missing m_game_menu_item_index from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerMouseWheelEvent {
        ...
        pub fn parse_m_wheel_spin(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTFixedMiniBitsSigned> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_wheel_spin: m_wheel_spin.expect("Missing m_wheel_spin from struct"),
                    m_flags: m_flags.expect("Missing m_flags from struct"),
                },
            ))
        }
    ...
    impl GameSTriggerPurchasePanelSelectedPurchaseCategoryChangedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_purchase_category_id: m_purchase_category_id
                        .expect("Missing m_purchase_category_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSTriggerCutsceneBookmarkFiredEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_cutscene_id: m_cutscene_id.expect("Missing m_cutscene_id from struct"),
    ...
    impl GameSTriggerCutsceneConversationLineEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                ...
                Self {
                    m_cutscene_id: m_cutscene_id.expect("Missing m_cutscene_id from struct"),
                    m_conversation_line: m_conversation_line
                        .expect("Missing m_conversation_line from struct"),
                    m_alt_conversation_line: m_alt_conversation_line
                        .expect("Missing m_alt_conversation_line from struct"),
                },
            ))
        }
    }
    ...
    impl GameSGameUserLeaveEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_leave_reason: m_leave_reason.expect("Missing m_leave_reason from struct"),
                },
            ))
        }
    }
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                ...
                Self {
                    ...
                    m_hijack_clone_game_user_id: m_hijack_clone_game_user_id
                        .expect("Missing m_hijack_clone_game_user_id from struct"),
                },
            ))
        }
    }
    ...
    impl GameSCommandManagerStateEvent {
        ...
        pub fn parse_m_state(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameECommandManagerState> {
    ...
    impl GameSCmdUpdateTargetUnitEvent {
        ...
        pub fn parse_m_target(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSCmdDataTargetUnit> {
    ...
    impl GameSCatalogModifyEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_catalog: m_catalog.expect("Missing m_catalog from struct"),
    ...
    impl GameSHeroTalentTreeSelectedEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_index: m_index.expect("Missing m_index from struct"),
                },
            ))
        }
    }
    ...
    impl GameSHeroTalentTreeSelectionPanelToggledEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_shown: m_shown.expect("Missing m_shown from struct"),
                },
            ))
        }
    }
    ...
    impl GameSMuteChatEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_target_user_id: m_target_user_id
                        .expect("Missing m_target_user_id from struct"),
    ...
    impl GameSSetSyncLoadingTimeEvent {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_sync_time: m_sync_time.expect("Missing m_sync_time from struct"),
                },
            ))
        }
    }
    ...
    impl GameSPoint {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    x: x.expect("Missing x from struct"),
    ...
    impl GameSPointMini {
        ...
        pub fn parse_x(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTFixedMiniBitsUnsigned> {
    ...
    impl GameSPlayerDetails {
        ...
        pub fn parse_m_toon(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSToonNameDetails> {
            let (tail, m_toon) = GameSToonNameDetails::parse(input)?;
            tracing::debug!("res: {:?}", m_toon);
            Ok((tail, m_toon))
        }
        ...
        pub fn parse_m_result(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameEResultDetails> {
            let (tail, m_result) = GameEResultDetails::parse(input)?;
            tracing::debug!("res: {:?}", m_result);
            Ok((tail, m_result))
        }
    ...
    impl GameSDetails {
        ...
        pub fn parse_m_game_speed(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameEGameSpeed> {
            let (tail, m_game_speed) = GameEGameSpeed::parse(input)?;
            tracing::debug!("res: {:?}", m_game_speed);
            Ok((tail, m_game_speed))
        }
        ...
        pub fn parse_m_default_difficulty(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTDifficulty> {
    ...
    impl GameSGameOptions {
        ...
        pub fn parse_m_observers(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameEOptionObservers> {
        ...
        pub fn parse_m_user_difficulty(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameEOptionUserDifficulty> {
        ...
        pub fn parse_m_client_debug_flags(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameEClientDebugFlags> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_lock_teams: m_lock_teams.expect("Missing m_lock_teams from struct"),
                    m_teams_together: m_teams_together
                        .expect("Missing m_teams_together from struct"),
                    m_advanced_shared_control: m_advanced_shared_control
                        .expect("Missing m_advanced_shared_control from struct"),
                    ...
                    m_no_victory_or_defeat: m_no_victory_or_defeat
                        .expect("Missing m_no_victory_or_defeat from struct"),
                    m_hero_duplicates_allowed: m_hero_duplicates_allowed
                        .expect("Missing m_hero_duplicates_allowed from struct"),
                    m_fog: m_fog.expect("Missing m_fog from struct"),
                    m_observers: m_observers.expect("Missing m_observers from struct"),
                    m_user_difficulty: m_user_difficulty
                        .expect("Missing m_user_difficulty from struct"),
                    m_client_debug_flags: m_client_debug_flags
                        .expect("Missing m_client_debug_flags from struct"),
                    m_build_coach_enabled: m_build_coach_enabled
                        .expect("Missing m_build_coach_enabled from struct"),
                },
            ))
        }
    }
    ...
    impl GameSSlotDescription {
        ...
        pub fn parse_m_allowed_colors(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCAllowedColors> {
        ...
        pub fn parse_m_allowed_races(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), CAllowedRaces> {
        ...
        pub fn parse_m_allowed_difficulty(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCAllowedDifficulty> {
        ...
        pub fn parse_m_allowed_controls(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCAllowedControls> {
        ...
        pub fn parse_m_allowed_observe_types(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), CAllowedObserveTypes> {
        ...
        pub fn parse_m_allowed_ai_builds(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCAllowedAiBuild> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_allowed_colors: m_allowed_colors
                        .expect("Missing m_allowed_colors from struct"),
                    m_allowed_races: m_allowed_races.expect("Missing m_allowed_races from struct"),
                    m_allowed_difficulty: m_allowed_difficulty
                        .expect("Missing m_allowed_difficulty from struct"),
                    m_allowed_controls: m_allowed_controls
                        .expect("Missing m_allowed_controls from struct"),
                    m_allowed_observe_types: m_allowed_observe_types
                        .expect("Missing m_allowed_observe_types from struct"),
                    m_allowed_ai_builds: m_allowed_ai_builds
                        .expect("Missing m_allowed_ai_builds from struct"),
                },
            ))
        }
    }
    ...
    impl GameSGameDescription {
        ...
        pub fn parse_m_game_cache_name(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCGameCacheName> {
        ...
        pub fn parse_m_game_options(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSGameOptions> {
        ...
        pub fn parse_m_max_players(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTPlayerCount> {
        ...
        pub fn parse_m_max_colors(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTColorCount> {
        ...
        pub fn parse_m_max_controls(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTControlCount> {
        ...
        pub fn parse_m_map_file_sync_checksum(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTSyncChecksum> {
        ...
        pub fn parse_m_map_author_name(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCAuthorName> {
        ...
        pub fn parse_m_slot_descriptions(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSSlotDescriptions> {
        ...
        pub fn parse_m_cache_handles(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCCacheHandles> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_random_value: m_random_value.expect("Missing m_random_value from struct"),
                    m_game_cache_name: m_game_cache_name
                        .expect("Missing m_game_cache_name from struct"),
                    ...
                    m_map_file_sync_checksum: m_map_file_sync_checksum
                        .expect("Missing m_map_file_sync_checksum from struct"),
                    m_map_file_name: m_map_file_name.expect("Missing m_map_file_name from struct"),
                    m_map_author_name: m_map_author_name
                        .expect("Missing m_map_author_name from struct"),
                    m_mod_file_sync_checksum: m_mod_file_sync_checksum
                        .expect("Missing m_mod_file_sync_checksum from struct"),
                    m_slot_descriptions: m_slot_descriptions
                        .expect("Missing m_slot_descriptions from struct"),
                    m_default_difficulty: m_default_difficulty
                        .expect("Missing m_default_difficulty from struct"),
                    m_default_ai_build: m_default_ai_build
                        .expect("Missing m_default_ai_build from struct"),
                    m_cache_handles: m_cache_handles.expect("Missing m_cache_handles from struct"),
                    m_has_extension_mod: m_has_extension_mod
                        .expect("Missing m_has_extension_mod from struct"),
                    m_has_non_blizzard_extension_mod: m_has_non_blizzard_extension_mod
                        .expect("Missing m_has_non_blizzard_extension_mod from struct"),
                    m_is_blizzard_map: m_is_blizzard_map
                        .expect("Missing m_is_blizzard_map from struct"),
                    m_is_premade_ffa: m_is_premade_ffa
                        .expect("Missing m_is_premade_ffa from struct"),
                    m_is_coop_mode: m_is_coop_mode.expect("Missing m_is_coop_mode from struct"),
                    m_is_realtime_mode: m_is_realtime_mode
                        .expect("Missing m_is_realtime_mode from struct"),
                },
            ))
        }
    }
    ...
    impl GameSLobbySlot {
        ...
        pub fn parse_m_color_pref(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTColorPreference> {
        ...
        pub fn parse_m_logo_index(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTPlayerLogoIndex> {
        ...
        pub fn parse_m_artifacts(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCArtifactArray> {
        ...
        pub fn parse_m_licenses(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCLicenseArray> {
        ...
        pub fn parse_m_commander(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), CCommanderHandle> {
        ...
        pub fn parse_m_commander_mastery_talents(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCCommanderMasteryTalentArray> {
        ...
        pub fn parse_m_reward_overrides(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCRewardOverrideArray> {
        ...
        pub fn parse_m_retry_mutation_indexes(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCRetryMutationIndexArray> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                ...
                Self {
                    ...
                    m_brutal_plus_difficulty: m_brutal_plus_difficulty
                        .expect("Missing m_brutal_plus_difficulty from struct"),
                    m_retry_mutation_indexes: m_retry_mutation_indexes
                        .expect("Missing m_retry_mutation_indexes from struct"),
                    m_a_c_enemy_race: m_a_c_enemy_race
                        .expect("Missing m_a_c_enemy_race from struct"),
                    m_a_c_enemy_wave_type: m_a_c_enemy_wave_type
                        .expect("Missing m_a_c_enemy_wave_type from struct"),
                    m_selected_commander_prestige: m_selected_commander_prestige
                        .expect("Missing m_selected_commander_prestige from struct"),
                },
            ))
        }
    }
    ...
    impl GameSLobbyState {
        ...
        pub fn parse_m_slots(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameCLobbySlotArray> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_phase: m_phase.expect("Missing m_phase from struct"),
                    m_max_users: m_max_users.expect("Missing m_max_users from struct"),
                    m_max_observers: m_max_observers.expect("Missing m_max_observers from struct"),
                    ...
                    m_is_single_player: m_is_single_player
                        .expect("Missing m_is_single_player from struct"),
                    m_picked_map_tag: m_picked_map_tag
                        .expect("Missing m_picked_map_tag from struct"),
                    m_game_duration: m_game_duration.expect("Missing m_game_duration from struct"),
                    m_default_difficulty: m_default_difficulty
    ...
    impl GameSLobbySyncState {
        ...
        pub fn parse_m_user_initial_data(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), CUserInitialDataArray> {
        ...
        pub fn parse_m_game_description(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSGameDescription> {
        ...
        pub fn parse_m_lobby_state(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSLobbyState> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_user_initial_data: m_user_initial_data
                        .expect("Missing m_user_initial_data from struct"),
                    m_game_description: m_game_description
                        .expect("Missing m_game_description from struct"),
    ...
    impl GameSChatMessage {
        ...
        pub fn parse_m_recipient(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameEMessageRecipient> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_recipient: m_recipient.expect("Missing m_recipient from struct"),
    ...
    impl GameSLoadingProgressMessage {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_progress: m_progress.expect("Missing m_progress from struct"),
                },
            ))
        }
    }
    ...
    impl GameSReconnectNotifyMessage {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_status: m_status.expect("Missing m_status from struct"),
                },
            ))
        }
    }
    ...
    impl GameSSelectionDeltaSubgroup {
        ...
        pub fn parse_m_subgroup_priority(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTSubgroupPriority> {
        ...
        pub fn parse_m_count(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTSelectionCount> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                ...
                Self {
                    m_unit_link: m_unit_link.expect("Missing m_unit_link from struct"),
                    m_subgroup_priority: m_subgroup_priority
                        .expect("Missing m_subgroup_priority from struct"),
                    m_intra_subgroup_priority: m_intra_subgroup_priority
                        .expect("Missing m_intra_subgroup_priority from struct"),
                    m_count: m_count.expect("Missing m_count from struct"),
                },
            ))
        }
    ...
    impl GameSSelectionDelta {
        ...
        pub fn parse_m_subgroup_index(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTSubgroupIndex> {
        ...
        pub fn parse_m_remove_mask(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameSSelectionMask> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_subgroup_index: m_subgroup_index
                        .expect("Missing m_subgroup_index from struct"),
    ...
    impl GameSSelectionSyncData {
        ...
        pub fn parse_m_subgroup_count(
            input: (&[u8], usize),
        ) -> IResult<(&[u8], usize), GameTSubgroupCount> {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                ...
                Self {
                    m_count: m_count.expect("Missing m_count from struct"),
                    m_subgroup_count: m_subgroup_count
                        .expect("Missing m_subgroup_count from struct"),
                    m_active_subgroup_index: m_active_subgroup_index
                        .expect("Missing m_active_subgroup_index from struct"),
                    m_unit_tags_checksum: m_unit_tags_checksum
                        .expect("Missing m_unit_tags_checksum from struct"),
                    m_subgroup_indices_checksum: m_subgroup_indices_checksum
                        .expect("Missing m_subgroup_indices_checksum from struct"),
                    m_subgroups_checksum: m_subgroups_checksum
                        .expect("Missing m_subgroups_checksum from struct"),
                },
            ))
        }
    }
    ...
    impl GameSSessionSyncInfo {
        ...
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            ...
            Ok((
                tail,
                Self {
                    m_checksums: m_checksums.expect("Missing m_checksums from struct"),
                },
            ))
        }
    }
