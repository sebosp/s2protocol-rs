...
pub mod byte_aligned {
    //! Generated code from source: ../s2protocol/json/protocol90136.json
    use crate::*;
    use nom::*;
    ...
    impl SVarUint32 {
        #[tracing::instrument(name="90136::SVarUint32::ChoiceType::parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
    ...
    impl EObserve {
        #[tracing::instrument(name="90136::EObserve::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
    ...
    impl SVersion {
        ...
        #[tracing::instrument(name="90136::byte_aligned::SVersion::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
    ...
    impl Smd5 {
        ...
        #[tracing::instrument(name="90136::byte_aligned::Smd5::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameEGameSpeed {
        #[tracing::instrument(name="90136::GameEGameSpeed::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_int_tag(input)?;
            let (tail, variant_tag) = parse_vlq_int(tail)?;
            match variant_tag {
    ...
    impl GameSThumbnail {
        ...
        #[tracing::instrument(name="90136::byte_aligned::GameSThumbnail::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameSColor {
        ...
        #[tracing::instrument(name="90136::byte_aligned::GameSColor::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameEResultDetails {
        #[tracing::instrument(name="90136::GameEResultDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_int_tag(input)?;
            let (tail, variant_tag) = parse_vlq_int(tail)?;
            match variant_tag {
    ...
    impl GameSToonNameDetails {
        ...
        #[tracing::instrument(name="90136::byte_aligned::GameSToonNameDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl GameSPlayerDetails {
        ...
        #[tracing::instrument(name="90136::byte_aligned::GameSPlayerDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_name: Option<Vec<u8>> = None;
    ...
    impl GameCPlayerDetailsArray {
        #[tracing::instrument(name="90136::GameCPlayerDetailsArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
    ...
    impl GameSDetails {
        ...
        #[tracing::instrument(name="90136::byte_aligned::GameSDetails::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl ReplaySHeader {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplaySHeader::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl ReplayTrackerEEventId {
        #[tracing::instrument(name="90136::ReplayTrackerEEventId::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_int_tag(input)?;
            let (tail, variant_tag) = parse_vlq_int(tail)?;
            match variant_tag {
    ...
    impl ReplayTrackerSPlayerStats {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSPlayerStats::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
...
m_score_value_vespene_friendly_fire_technology: m_score_value_vespene_friendly_fire_technology.expect("Missing m_score_value_vespene_friendly_fire_technology from struct"),
    ...
    impl ReplayTrackerSPlayerStatsEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSPlayerStatsEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl ReplayTrackerSUnitBornEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSUnitBornEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl ReplayTrackerSUnitDiedEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSUnitDiedEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_unit_tag_index: Option<u32> = None;
    ...
    impl ReplayTrackerSUnitOwnerChangeEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSUnitOwnerChangeEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_unit_tag_index: Option<u32> = None;
    ...
    impl ReplayTrackerSUnitTypeChangeEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSUnitTypeChangeEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_unit_tag_index: Option<u32> = None;
    ...
    impl ReplayTrackerSUpgradeEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSUpgradeEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_player_id: Option<u8> = None;
    ...
    impl ReplayTrackerSUnitInitEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSUnitInitEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_unit_tag_index: Option<u32> = None;
    ...
    impl ReplayTrackerSUnitDoneEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSUnitDoneEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_unit_tag_index: Option<u32> = None;
    ...
    impl ReplayTrackerSUnitPositionsEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSUnitPositionsEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
    ...
    impl ReplayTrackerSPlayerSetupEvent {
        ...
        #[tracing::instrument(name="90136::byte_aligned::ReplayTrackerSPlayerSetupEvent::Parse", level = "debug", skip(input), fields(peek = peek_hex(input)))]
        pub fn parse(input: &[u8]) -> IResult<&[u8], Self> {
            let (tail, _) = validate_struct_tag(input)?;
            let (mut tail, struct_field_count) = parse_vlq_int(tail)?;
            let mut m_player_id: Option<u8> = None;
...
pub mod bit_packed {
    ...
    impl CFilePath {
        #[tracing::instrument(name="90136::CFilePath::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
    ...
    impl TRaceId {
        #[tracing::instrument(name="90136::TRaceId::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
    ...
    impl TRaceCount {
        #[tracing::instrument(name="90136::TRaceCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 1;
            let num_bits: usize = 8;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl TRacePreference {
        ...
        #[tracing::instrument(name="90136::bit_packed::TRacePreference::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl CAllowedRaces {
        #[tracing::instrument(name="90136::CAllowedRaces::BitArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl Int8 {
        #[tracing::instrument(name="90136::Int8::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = -128;
            let num_bits: usize = 8;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl Int16 {
        #[tracing::instrument(name="90136::Int16::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl Int32 {
        #[tracing::instrument(name="90136::Int32::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl Int64 {
        #[tracing::instrument(name="90136::Int64::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl Uint8 {
        #[tracing::instrument(name="90136::Uint8::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 8;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl Uint16 {
        #[tracing::instrument(name="90136::Uint16::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 16;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl Uint32 {
        #[tracing::instrument(name="90136::Uint32::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 32;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl Uint64 {
        #[tracing::instrument(name="90136::Uint64::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 64;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl Uint6 {
        #[tracing::instrument(name="90136::Uint6::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
    ...
    impl Uint14 {
        #[tracing::instrument(name="90136::Uint14::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
    ...
    impl Uint22 {
        #[tracing::instrument(name="90136::Uint22::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
    ...
    impl SVarUint32 {
        #[tracing::instrument(name="90136::SVarUint32::ChoiceType::parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // ChoiceType:
    ...
    impl TUserId {
        #[tracing::instrument(name="90136::TUserId::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
    ...
    impl TUserCount {
        #[tracing::instrument(name="90136::TUserCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
    ...
    impl CCacheHandle {
        #[tracing::instrument(name="90136::CCacheHandle::BlobType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl CUserName {
        #[tracing::instrument(name="90136::CUserName::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl CClanTag {
        #[tracing::instrument(name="90136::CClanTag::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 8;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl CHeroHandle {
        #[tracing::instrument(name="90136::CHeroHandle::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl CSkinHandle {
        #[tracing::instrument(name="90136::CSkinHandle::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 10;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl CMountHandle {
        #[tracing::instrument(name="90136::CMountHandle::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 10;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl CArtifactHandle {
        #[tracing::instrument(name="90136::CArtifactHandle::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 10;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl CToonHandle {
        #[tracing::instrument(name="90136::CToonHandle::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl CCommanderHandle {
        #[tracing::instrument(name="90136::CCommanderHandle::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 10;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl EObserve {
        #[tracing::instrument(name="90136::EObserve::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 3
            let num_bits: usize = 2;
    ...
    impl CAllowedObserveTypes {
        #[tracing::instrument(name="90136::CAllowedObserveTypes::BitArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl TTeamPreference {
        ...
        #[tracing::instrument(name="90136::bit_packed::TTeamPreference::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl SUserInitialData {
        ...
        #[tracing::instrument(name="90136::bit_packed::SUserInitialData::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl CUserInitialDataArray {
        #[tracing::instrument(name="90136::CUserInitialDataArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl ELeaveReason {
        #[tracing::instrument(name="90136::ELeaveReason::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 16
            let num_bits: usize = 4;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl EReconnectStatus {
        #[tracing::instrument(name="90136::EReconnectStatus::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 4
            let num_bits: usize = 2;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl SVersion {
        ...
        #[tracing::instrument(name="90136::bit_packed::SVersion::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl Smd5 {
        ...
        #[tracing::instrument(name="90136::bit_packed::Smd5::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameTColorId {
        #[tracing::instrument(name="90136::GameTColorId::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 5;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTColorCount {
        #[tracing::instrument(name="90136::GameTColorCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 6;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTColorPreference {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameTColorPreference::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameCAllowedColors {
        #[tracing::instrument(name="90136::GameCAllowedColors::BitArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameESynchronous {
        #[tracing::instrument(name="90136::GameESynchronous::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 3
            let num_bits: usize = 2;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameESynthesized {
        #[tracing::instrument(name="90136::GameESynthesized::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 2
    ...
    impl GameEDebug {
        #[tracing::instrument(name="90136::GameEDebug::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 2
            let num_bits: usize = 1;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameEHijackMethod {
        #[tracing::instrument(name="90136::GameEHijackMethod::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 2
            let num_bits: usize = 1;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameTQueryId {
        #[tracing::instrument(name="90136::GameTQueryId::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameEEventId {
        #[tracing::instrument(name="90136::GameEEventId::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 120
    ...
    impl GameSCmdAbil {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCmdAbil::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSCmdDataTargetUnit {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCmdDataTargetUnit::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSCmdData {
        #[tracing::instrument(name="90136::GameSCmdData::ChoiceType::parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // ChoiceType:
            // Use the number of elements in the json .fields to calculate how many
            // bits to have unique tags.
    ...
    impl GameSSetLobbySlotEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSetLobbySlotEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSDropUserEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSDropUserEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSStartGameEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSStartGameEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSDropOurselvesEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSDropOurselvesEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSBankFileEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSBankFileEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_name: Option<Vec<u8>> = None;
            if m_name.is_none() {
    ...
    impl GameSBankSectionEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSBankSectionEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_name: Option<Vec<u8>> = None;
            if m_name.is_none() {
    ...
    impl GameSBankKeyEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSBankKeyEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_name: Option<Vec<u8>> = None;
    ...
    impl GameSBankValueEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSBankValueEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_type: Option<Uint32> = None;
            let mut m_name: Option<Vec<u8>> = None;
    ...
    impl GameSBankSignatureEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSBankSignatureEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSUserOptionsEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSUserOptionsEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSPickMapTagEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSPickMapTagEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSUserFinishedLoadingEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSUserFinishedLoadingEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSUserFinishedLoadingSyncEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSUserFinishedLoadingSyncEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSSetGameDurationEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSetGameDurationEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTurnEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTurnEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSCameraSaveEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCameraSaveEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSPauseGameEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSPauseGameEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSUnpauseGameEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSUnpauseGameEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_pause_type_index: Option<Uint8> = None;
            if m_pause_type_index.is_none() {
    ...
    impl GameSSingleStepGameEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSSingleStepGameEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSSetGameSpeedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSetGameSpeedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSAddGameSpeedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSAddGameSpeedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSReplayJumpEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSReplayJumpEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSSaveGameEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSaveGameEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSSaveGameDoneEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSSaveGameDoneEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSLoadGameDoneEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSLoadGameDoneEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSCheatEventData {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCheatEventData::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSSessionCheatEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSessionCheatEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSCommandManagerResetEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCommandManagerResetEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSGameCheatEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSGameCheatEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_data: Option<GameSCheatEventData> = None;
            if m_data.is_none() {
    ...
    impl GameSCmdEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCmdEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSSelectionDeltaEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSelectionDeltaEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSControlGroupUpdateEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSControlGroupUpdateEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSSelectionSyncCheckEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSelectionSyncCheckEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_control_group_id: Option<GameTControlGroupId> = None;
    ...
    impl GameSResourceTradeEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSResourceTradeEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerChatMessageEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerChatMessageEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSaiCommunicateEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSaiCommunicateEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSSetAbsoluteGameSpeedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSetAbsoluteGameSpeedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_speed: Option<GameEGameSpeed> = None;
            if m_speed.is_none() {
    ...
    impl GameSAddAbsoluteGameSpeedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSAddAbsoluteGameSpeedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_delta: Option<Int8> = None;
            if m_delta.is_none() {
    ...
    impl GameSTriggerPingEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPingEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_point: Option<GameSPoint> = None;
    ...
    impl GameSBroadcastCheatEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSBroadcastCheatEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_verb: Option<GameCCheatString> = None;
            let mut m_arguments: Option<GameCCheatString> = None;
    ...
    impl GameSAllianceEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSAllianceEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSUnitClickEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSUnitClickEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSUnitHighlightEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSUnitHighlightEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_unit_tag: Option<GameTUnitTag> = None;
            let mut m_flags: Option<Uint8> = None;
    ...
    impl GameSTriggerReplySelectedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerReplySelectedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSHijackReplaySessionUserInfo {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSHijackReplaySessionUserInfo::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSHijackReplaySessionEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSHijackReplaySessionEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSHijackReplayGameUserInfo {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSHijackReplayGameUserInfo::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_game_user_id: Option<TUserId> = None;
            let mut m_observe: Option<EObserve> = None;
    ...
    impl GameSHijackReplayGameEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSHijackReplayGameEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerAbortMissionEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerAbortMissionEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerPurchaseMadeEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPurchaseMadeEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerPurchaseExitEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPurchaseExitEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerPlanetMissionLaunchedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPlanetMissionLaunchedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerPlanetPanelCanceledEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPlanetPanelCanceledEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerDialogControlEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerDialogControlEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl MEventData {
        #[tracing::instrument(name="90136::MEventData::ChoiceType::parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // ChoiceType:
            // Use the number of elements in the json .fields to calculate how many
            // bits to have unique tags.
    ...
    impl GameSTriggerSkippedEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerSkippedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerSoundLengthQueryEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerSoundLengthQueryEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerSoundLengthSyncEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerSoundLengthSyncEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerAnimLengthQueryByNameEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerAnimLengthQueryByNameEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerAnimLengthQueryByPropsEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerAnimLengthQueryByPropsEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_query_id: Option<GameTQueryId> = None;
            let mut m_length_ms: Option<Uint32> = None;
    ...
    impl GameSTriggerAnimOffsetEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerAnimOffsetEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerSoundOffsetEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerSoundOffsetEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerTransmissionOffsetEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerTransmissionOffsetEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerTransmissionCompleteEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerTransmissionCompleteEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_transmission_id: Option<Int32> = None;
            if m_transmission_id.is_none() {
    ...
    impl GameSCameraUpdateEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCameraUpdateEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerConversationSkippedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerConversationSkippedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerMouseClickedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerMouseClickedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerMouseMovedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerMouseMovedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_pos_ui: Option<GameSuiCoord> = None;
            let mut m_pos_world: Option<GameSMapCoord3D> = None;
    ...
    impl GameSAchievementAwardedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSAchievementAwardedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerHotkeyPressedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerHotkeyPressedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerTargetModeUpdateEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerTargetModeUpdateEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_abil_link: Option<GameTAbilLink> = None;
            let mut m_abil_cmd_index: Option<i64> = None;
    ...
    impl GameSTriggerPlanetPanelReplayEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPlanetPanelReplayEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerSoundtrackDoneEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerSoundtrackDoneEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerPlanetMissionSelectedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPlanetMissionSelectedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerKeyPressedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerKeyPressedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerPlanetPanelBirthCompleteEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPlanetPanelBirthCompleteEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerPlanetPanelDeathCompleteEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPlanetPanelDeathCompleteEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSResourceRequestEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSResourceRequestEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_resources: Option<Vec<Int32>> = None;
            if m_resources.is_none() {
    ...
    impl GameSResourceRequestFulfillEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSResourceRequestFulfillEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSResourceRequestCancelEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSResourceRequestCancelEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerResearchPanelExitEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerResearchPanelExitEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerResearchPanelPurchaseEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerResearchPanelPurchaseEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerCommandErrorEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerCommandErrorEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerResearchPanelSelectionChangedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerResearchPanelSelectionChangedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerMercenaryPanelExitEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerMercenaryPanelExitEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerMercenaryPanelPurchaseEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerMercenaryPanelPurchaseEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerMercenaryPanelSelectionChangedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerMercenaryPanelSelectionChangedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerVictoryPanelExitEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerVictoryPanelExitEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerBattleReportPanelExitEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerBattleReportPanelExitEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerBattleReportPanelPlayMissionEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerBattleReportPanelPlayMissionEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerBattleReportPanelPlaySceneEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerBattleReportPanelPlaySceneEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_battle_report_id: Option<Int32> = None;
            if m_battle_report_id.is_none() {
    ...
    impl GameSTriggerBattleReportPanelSelectionChangedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerBattleReportPanelSelectionChangedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_battle_report_id: Option<Int32> = None;
            if m_battle_report_id.is_none() {
    ...
    impl GameSTriggerVictoryPanelPlayMissionAgainEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerVictoryPanelPlayMissionAgainEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_difficulty_level: Option<Int32> = None;
            if m_difficulty_level.is_none() {
    ...
    impl GameSTriggerMovieStartedEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerMovieStartedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerMovieFinishedEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerMovieFinishedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSDecrementGameTimeRemainingEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSDecrementGameTimeRemainingEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerPortraitLoadedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPortraitLoadedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerMovieFunctionEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerMovieFunctionEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerCustomDialogDismissedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerCustomDialogDismissedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerGameMenuItemSelectedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerGameMenuItemSelectedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerMouseWheelEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerMouseWheelEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerPurchasePanelSelectedPurchaseItemChangedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPurchasePanelSelectedPurchaseItemChangedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_purchase_item_id: Option<Int32> = None;
            if m_purchase_item_id.is_none() {
    ...
    impl GameSTriggerPurchasePanelSelectedPurchaseCategoryChangedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerPurchasePanelSelectedPurchaseCategoryChangedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerButtonPressedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerButtonPressedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerGameCreditsFinishedEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerGameCreditsFinishedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSTriggerCutsceneBookmarkFiredEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerCutsceneBookmarkFiredEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerCutsceneEndSceneFiredEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerCutsceneEndSceneFiredEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_cutscene_id: Option<Int32> = None;
            if m_cutscene_id.is_none() {
    ...
    impl GameSTriggerCutsceneConversationLineEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerCutsceneConversationLineEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_cutscene_id: Option<Int32> = None;
    ...
    impl GameSTriggerCutsceneConversationLineMissingEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerCutsceneConversationLineMissingEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_cutscene_id: Option<Int32> = None;
            let mut m_conversation_line: Option<Vec<u8>> = None;
    ...
    impl GameSGameUserLeaveEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSGameUserLeaveEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSGameUserJoinEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSGameUserJoinEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_observe: Option<EObserve> = None;
            let mut m_name: Option<CUserName> = None;
    ...
    impl GameECommandManagerState {
        #[tracing::instrument(name="90136::GameECommandManagerState::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 3
            let num_bits: usize = 2;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameSCommandManagerStateEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCommandManagerStateEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSCmdUpdateTargetPointEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCmdUpdateTargetPointEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSCmdUpdateTargetUnitEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCmdUpdateTargetUnitEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSCatalogModifyEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSCatalogModifyEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSHeroTalentTreeSelectedEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSHeroTalentTreeSelectedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSTriggerProfilerLoggingFinishedEvent {
        #[tracing::instrument(name="90136::bit_packed::GameSTriggerProfilerLoggingFinishedEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSHeroTalentTreeSelectionPanelToggledEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSHeroTalentTreeSelectionPanelToggledEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSMuteChatEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSMuteChatEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSConvertToReplaySessionEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSConvertToReplaySessionEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSSetSyncLoadingTimeEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSetSyncLoadingTimeEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSSetSyncPlayingTimeEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSetSyncPlayingTimeEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_sync_time: Option<Uint32> = None;
            if m_sync_time.is_none() {
    ...
    impl GameSPeerSetSyncLoadingTimeEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSPeerSetSyncLoadingTimeEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_sync_time: Option<Uint32> = None;
            if m_sync_time.is_none() {
    ...
    impl GameSPeerSetSyncPlayingTimeEvent {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSPeerSetSyncPlayingTimeEvent::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_sync_time: Option<Uint32> = None;
            if m_sync_time.is_none() {
    ...
    impl GameEGameSpeed {
        #[tracing::instrument(name="90136::GameEGameSpeed::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 5
            let num_bits: usize = 3;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameEPhase {
        #[tracing::instrument(name="90136::GameEPhase::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 6
            let num_bits: usize = 3;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameEConversationSkip {
        #[tracing::instrument(name="90136::GameEConversationSkip::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 2
            let num_bits: usize = 1;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameCCheatString {
        #[tracing::instrument(name="90136::GameCCheatString::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 11;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl GameCTriggerChatMessageString {
        #[tracing::instrument(name="90136::GameCTriggerChatMessageString::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 11;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl GameTAchievementLink {
        #[tracing::instrument(name="90136::GameTAchievementLink::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint16::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTAchievementTermLink {
        #[tracing::instrument(name="90136::GameTAchievementTermLink::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint16::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTButtonLink {
        #[tracing::instrument(name="90136::GameTButtonLink::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint16::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTUnitLink {
        #[tracing::instrument(name="90136::GameTUnitLink::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint16::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTUnitTag {
        #[tracing::instrument(name="90136::GameTUnitTag::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameTTriggerThreadTag {
        #[tracing::instrument(name="90136::GameTTriggerThreadTag::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint32::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTTriggerSoundTag {
        #[tracing::instrument(name="90136::GameTTriggerSoundTag::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint32::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTAbilLink {
        #[tracing::instrument(name="90136::GameTAbilLink::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint16::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTFixedBits {
        #[tracing::instrument(name="90136::GameTFixedBits::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameTFixedMiniBitsUnsigned {
        #[tracing::instrument(name="90136::GameTFixedMiniBitsUnsigned::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint16::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTFixedMiniBitsSigned {
        #[tracing::instrument(name="90136::GameTFixedMiniBitsSigned::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameTPlayerLogoIndex {
        #[tracing::instrument(name="90136::GameTPlayerLogoIndex::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint32::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTFixedInt {
        #[tracing::instrument(name="90136::GameTFixedInt::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameTFixedUInt {
        #[tracing::instrument(name="90136::GameTFixedUInt::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
    ...
    impl GameTMapCoordFixedBits {
        #[tracing::instrument(name="90136::GameTMapCoordFixedBits::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 20;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTuiCoordX {
        #[tracing::instrument(name="90136::GameTuiCoordX::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
    ...
    impl GameTuiCoordY {
        #[tracing::instrument(name="90136::GameTuiCoordY::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 11;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTHeroLink {
        #[tracing::instrument(name="90136::GameTHeroLink::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint16::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameSPoint {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSPoint::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSPoint3 {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSPoint3::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut x: Option<GameTFixedBits> = None;
            let mut y: Option<GameTFixedBits> = None;
    ...
    impl GameSPointMini {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSPointMini::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSMapCoord {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSMapCoord::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSMapCoord3D {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSMapCoord3D::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut x: Option<GameTMapCoordFixedBits> = None;
            let mut y: Option<GameTMapCoordFixedBits> = None;
    ...
    impl GameSuiCoord {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSuiCoord::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameTHandicap {
        #[tracing::instrument(name="90136::GameTHandicap::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint32::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTDifficulty {
        #[tracing::instrument(name="90136::GameTDifficulty::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 6;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameCAllowedDifficulty {
        #[tracing::instrument(name="90136::GameCAllowedDifficulty::BitArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let bitarray_length_bits: usize = 6;
            let (tail, bitarray_length) = take_n_bits_into_i64(input, bitarray_length_bits)?;
            let (tail, value) = take_bit_array(tail, bitarray_length as usize)?;
    ...
    impl GameTaiBuild {
        #[tracing::instrument(name="90136::GameTaiBuild::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 8;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameCAllowedAiBuild {
        #[tracing::instrument(name="90136::GameCAllowedAiBuild::BitArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let bitarray_length_bits: usize = 8;
            let (tail, bitarray_length) = take_n_bits_into_i64(input, bitarray_length_bits)?;
            let (tail, value) = take_bit_array(tail, bitarray_length as usize)?;
    ...
    impl GameSSyncSoundLength {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSyncSoundLength::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSThumbnail {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSThumbnail::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_file: Option<Vec<u8>> = None;
            if m_file.is_none() {
    ...
    impl GameSColor {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSColor::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameEResultDetails {
        #[tracing::instrument(name="90136::GameEResultDetails::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 4
            let num_bits: usize = 2;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameSToonNameDetails {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSToonNameDetails::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSPlayerDetails {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSPlayerDetails::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_name: Option<CUserName> = None;
            let mut m_toon: Option<GameSToonNameDetails> = None;
    ...
    impl GameCPlayerDetailsArray {
        #[tracing::instrument(name="90136::GameCPlayerDetailsArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let array_length_num_bits: usize = 5;
            let (tail, array_length) = parse_packed_int(input, 0, array_length_num_bits)?;
            let (tail, value) =
    ...
    impl GameCModPaths {
        #[tracing::instrument(name="90136::GameCModPaths::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameSDetails {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSDetails::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameEOptionFog {
        #[tracing::instrument(name="90136::GameEOptionFog::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 4
            let num_bits: usize = 2;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameEOptionObservers {
        #[tracing::instrument(name="90136::GameEOptionObservers::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 4
            let num_bits: usize = 2;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameEOptionUserDifficulty {
        #[tracing::instrument(name="90136::GameEOptionUserDifficulty::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 3
            let num_bits: usize = 2;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameEGameLaunch {
        #[tracing::instrument(name="90136::GameEGameLaunch::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 6
            let num_bits: usize = 3;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameEClientDebugFlags {
        #[tracing::instrument(name="90136::GameEClientDebugFlags::IntType::Parse::PowExpr", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 64;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameSGameOptions {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSGameOptions::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameEGameType {
        #[tracing::instrument(name="90136::GameEGameType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 7
            let num_bits: usize = 3;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameEControl {
        #[tracing::instrument(name="90136::GameEControl::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 4
            let num_bits: usize = 2;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameTControlId {
        #[tracing::instrument(name="90136::GameTControlId::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 8;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTControlCount {
        #[tracing::instrument(name="90136::GameTControlCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 8;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameCAllowedControls {
        #[tracing::instrument(name="90136::GameCAllowedControls::BitArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let bitarray_length_bits: usize = 8;
            let (tail, bitarray_length) = take_n_bits_into_i64(input, bitarray_length_bits)?;
            let (tail, value) = take_bit_array(tail, bitarray_length as usize)?;
    ...
    impl GameSSlotDescription {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSlotDescription::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameCCacheHandle {
        #[tracing::instrument(name="90136::GameCCacheHandle::BlobType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, _) = byte_align(input)?;
            let num_bits: usize = 6;
            let (tail, value) = take_bit_array(tail, num_bits)?;
    ...
    impl GameCCacheHandles {
        #[tracing::instrument(name="90136::GameCCacheHandles::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let array_length_num_bits: usize = 6;
            let (tail, array_length) = parse_packed_int(input, 0, array_length_num_bits)?;
            let (tail, value) =
    ...
    impl GameCGameCacheName {
        #[tracing::instrument(name="90136::GameCGameCacheName::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 11;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl GameCAuthorName {
        #[tracing::instrument(name="90136::GameCAuthorName::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 8;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl GameSSlotDescriptions {
        #[tracing::instrument(name="90136::GameSSlotDescriptions::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let array_length_num_bits: usize = 5;
            let (tail, array_length) = parse_packed_int(input, 0, array_length_num_bits)?;
            let (tail, value) =
    ...
    impl GameSGameDescription {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSGameDescription::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameTLobbySlotCount {
        #[tracing::instrument(name="90136::GameTLobbySlotCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 5;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTLobbySlotId {
        #[tracing::instrument(name="90136::GameTLobbySlotId::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 4;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameCArtifactArray {
        #[tracing::instrument(name="90136::GameCArtifactArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameCCommanderMasteryTalentArray {
        #[tracing::instrument(name="90136::GameCCommanderMasteryTalentArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameCRetryMutationIndexArray {
        #[tracing::instrument(name="90136::GameCRetryMutationIndexArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let array_length_num_bits: usize = 3;
            let (tail, array_length) = parse_packed_int(input, 0, array_length_num_bits)?;
            let (tail, value) = nom::multi::count(Uint32::parse, array_length as usize)(tail)?;
    ...
    impl GameTReward {
        #[tracing::instrument(name="90136::GameTReward::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint32::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameCRewardArray {
        #[tracing::instrument(name="90136::GameCRewardArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameCRewardOverride {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameCRewardOverride::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameCRewardOverrideArray {
        #[tracing::instrument(name="90136::GameCRewardOverrideArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let array_length_num_bits: usize = 17;
            let (tail, array_length) = parse_packed_int(input, 0, array_length_num_bits)?;
            let (tail, value) =
    ...
    impl GameTLicense {
        #[tracing::instrument(name="90136::GameTLicense::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint32::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameCLicenseArray {
        #[tracing::instrument(name="90136::GameCLicenseArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameTFlexLicenseName {
        #[tracing::instrument(name="90136::GameTFlexLicenseName::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 8;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl GameTFlexLicenseAttributeName {
        #[tracing::instrument(name="90136::GameTFlexLicenseAttributeName::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 8;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl GameTFlexLicenseAttributeValue {
        #[tracing::instrument(name="90136::GameTFlexLicenseAttributeValue::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 11;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl GameSLobbySlot {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSLobbySlot::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_control: Option<GameTControlId> = None;
    ...
    impl GameCLobbySlotArray {
        #[tracing::instrument(name="90136::GameCLobbySlotArray::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let array_length_num_bits: usize = 5;
            let (tail, array_length) = parse_packed_int(input, 0, array_length_num_bits)?;
            let (tail, value) =
    ...
    impl GameSLobbySlotChange {
        #[tracing::instrument(name="90136::GameSLobbySlotChange::ChoiceType::parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // ChoiceType:
            // Use the number of elements in the json .fields to calculate how many
            // bits to have unique tags.
    ...
    impl GameSLobbyState {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSLobbyState::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSLobbySyncState {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSLobbySyncState::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameEMessageRecipient {
        #[tracing::instrument(name="90136::GameEMessageRecipient::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 5
            let num_bits: usize = 3;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameCChatString {
        #[tracing::instrument(name="90136::GameCChatString::StringType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let str_size_num_bits: usize = 11;
            let (tail, str_size) = parse_packed_int(input, 0, str_size_num_bits)?;
            let (tail, _) = byte_align(tail)?;
    ...
    impl GameSChatMessage {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSChatMessage::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSPingMessage {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSPingMessage::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_recipient: Option<GameEMessageRecipient> = None;
            let mut m_point: Option<GameSPoint> = None;
    ...
    impl GameSLoadingProgressMessage {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSLoadingProgressMessage::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSServerPingMessage {
        #[tracing::instrument(name="90136::bit_packed::GameSServerPingMessage::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let tail = input;
            Ok((tail, Self {}))
        }
    ...
    impl GameSReconnectNotifyMessage {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSReconnectNotifyMessage::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameTPlayerId {
        #[tracing::instrument(name="90136::GameTPlayerId::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 4;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTPlayerCount {
        #[tracing::instrument(name="90136::GameTPlayerCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 5;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameEResultCode {
        #[tracing::instrument(name="90136::GameEResultCode::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 4
            let num_bits: usize = 2;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameEControlGroupUpdate {
        #[tracing::instrument(name="90136::GameEControlGroupUpdate::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // Total fields: 6
            let num_bits: usize = 3;
            let (tail, variant_tag) = parse_packed_int(input, 0, num_bits)?;
    ...
    impl GameTSelectionCount {
        #[tracing::instrument(name="90136::GameTSelectionCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
    ...
    impl GameTSelectionIndex {
        #[tracing::instrument(name="90136::GameTSelectionIndex::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 9;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTSubgroupPriority {
        #[tracing::instrument(name="90136::GameTSubgroupPriority::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 8;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTSubgroupCount {
        #[tracing::instrument(name="90136::GameTSubgroupCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 9;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTSubgroupIndex {
        #[tracing::instrument(name="90136::GameTSubgroupIndex::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 9;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTControlGroupCount {
        #[tracing::instrument(name="90136::GameTControlGroupCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 4;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTControlGroupIndex {
        #[tracing::instrument(name="90136::GameTControlGroupIndex::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 4;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTControlGroupId {
        #[tracing::instrument(name="90136::GameTControlGroupId::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 4;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameSSelectionDeltaSubgroup {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSelectionDeltaSubgroup::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_unit_link: Option<GameTUnitLink> = None;
    ...
    impl GameSelectionIndexArrayType {
        #[tracing::instrument(name="90136::GameSelectionIndexArrayType::ArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameSelectionMaskType {
        #[tracing::instrument(name="90136::GameSelectionMaskType::BitArrayType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
    ...
    impl GameSSelectionMask {
        #[tracing::instrument(name="90136::GameSSelectionMask::ChoiceType::parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            // ChoiceType:
            // Use the number of elements in the json .fields to calculate how many
            // bits to have unique tags.
    ...
    impl GameSSelectionDelta {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSelectionDelta::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSSelectionSyncData {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSelectionSyncData::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_count: Option<GameTSelectionCount> = None;
    ...
    impl GameTSyncChecksum {
        #[tracing::instrument(name="90136::GameTSyncChecksum::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint32::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameTSyncValue {
        #[tracing::instrument(name="90136::GameTSyncValue::UserType::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let (tail, value) = Uint16::parse(input)?;
            Ok((tail, Self { value }))
        }
    ...
    impl GameSSessionSyncInfo {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSSessionSyncInfo::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
    ...
    impl GameSGameSyncInfo {
        ...
        #[tracing::instrument(name="90136::bit_packed::GameSGameSyncInfo::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
            let mut m_checksums: Option<Vec<GameTSyncChecksum>> = None;
            if m_checksums.is_none() {
    ...
    impl GameTTeamId {
        #[tracing::instrument(name="90136::GameTTeamId::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 0;
            let num_bits: usize = 4;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl GameTTeamCount {
        #[tracing::instrument(name="90136::GameTTeamCount::IntType::Parse::MinMaxConstraint", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let offset: i64 = 1;
            let num_bits: usize = 5;
            let (tail, res) = parse_packed_int(input, offset, num_bits)?;
    ...
    impl ReplaySGameUserId {
        ...
        #[tracing::instrument(name="90136::bit_packed::ReplaySGameUserId::Parse", level = "debug", skip(input), fields(peek = peek_bits(input)))]
        pub fn parse(input: (&[u8], usize)) -> IResult<(&[u8], usize), Self> {
            let mut tail = input;
